...
namespace meradgen {
    ...
    /////////////////////////////////////////////////////////////////////////////////////
    // Fixed constants. Live values are MERADGEN Fortran literals (parity pass).
    // PDG 2024/25 lines stay commented for a later meradgen-cpp-* tree.
    /////////////////////////////////////////////////////////////////////////////////////

    // const double pi   = acos(-1.0);              // [source C++ idiom]
    ...
    const double alfa   = 0.729735e-2;              // fine structure constant [source MERADGEN Fortran]

    // const double m    = 0.51099895e-3;           // electron mass (GeV) [source PDG 2024/25]
    const double m      = 0.511000e-3;              // electron mass (GeV) [source MERADGEN Fortran]

    // const double m2   = m * m;                   // electron mass squared [source PDG, derived]
    const double m2     = 0.261112e-6;              // electron mass squared [source MERADGEN Fortran; not equal to m*m]

    // const double barn = 0.38937966e6;            // (hbar*c)^2 (GeV^2 ub) [source PDG]
    const double barn   = 0.389379e6;               // [source MERADGEN Fortran]

    // Muon/tau are not in the Fortran commons. Values are PDG 2024/25 and are
    // unused while vacpol() uses the Fortran am2 DATA line.
    ...
    double vprad[4] = {0}, phirad[4] = {0}, weight = 0., xs0_save = 0.; // Originally floats in FORTRAN
