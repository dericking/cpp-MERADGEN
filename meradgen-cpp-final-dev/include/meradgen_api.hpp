...
// Main event generation: ppl = polarization, vpgen = (px,py,pz,E) GeV of the virtual photon
// Outputs in globals: vprad, phirad, weight, ich, xs0_save, sirad_out, sinonr_out, vgen, t1gen, zgen
